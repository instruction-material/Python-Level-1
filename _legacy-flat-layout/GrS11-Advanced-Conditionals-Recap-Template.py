...
# Change your code so that your random number is between 1 and 20. Next, add 2 more elifs which draw a circle and rectangle if other possible numbers occur.
