...
# Create a variable called num and set it to a random number between 0 and 10. If num is less than 5, set it equal to 0. If num is equal to 5, set it to 10. Otherwise, set it to 15.
